...
export interface IRestaurantAdminUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
...
export class RestaurantAdminUpdate extends React.Component<IRestaurantAdminUpdateProps, IRestaurantAdminUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/entity/restaurant-admin');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="orderOnlineFrontEndApp.restaurantAdmin.home.createOrEditLabel">
              <Translate contentKey="orderOnlineFrontEndApp.restaurantAdmin.home.createOrEditLabel">
                Create or edit a RestaurantAdmin
              </Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : restaurantAdminEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="id">
                      <Translate contentKey="global.field.id">ID</Translate>
                    </Label>
                    <AvInput id="restaurant-admin-id" type="text" className="form-control" name="id" required readOnly />
                  </AvGroup>
                ) : null}
                <AvGroup>
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.restaurantAdmin.updateSuccess
});
