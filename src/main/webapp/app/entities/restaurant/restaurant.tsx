    ...
    return (
      <div>
        <h2 id="restaurant-heading">
          <Translate contentKey="orderOnlineFrontEndApp.restaurant.home.title">Restaurants</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="orderOnlineFrontEndApp.restaurant.home.createLabel">Create new Restaurant</Translate>
          </Link>
        </h2>
